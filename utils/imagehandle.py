# Support functions to help with the image processing, scoring and visualization
...
# Create request json file for scoring
...
# Create request json file for scoring frontal image only
def write_request_file_frontal_only(
    frontal_path,
    indication,
    technique,
    comparison,
    request_file_name="sample_request_data_frontal_only.json",
):
    """Scores only the frontal image using the deployed model."""
